...
The dataset used is the Heart Disease UCI Dataset, which is publicly available on Kaggle
. The dataset contains various attributes such as age, sex, blood pressure, cholesterol, and other health metrics relevant to heart disease prediction.
